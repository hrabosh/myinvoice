...
final class ProvisionReviziorOrganizationAction
{
    public function __construct(
        private readonly ReviziorOrganizationProvisioner $provisioner,
    ...
    public function __invoke(Request $request, Response $response, array $args): Response
    {
        ...
        try {
            ...
            $this->logger->error('ReviziOR organization provisioning failed', [
