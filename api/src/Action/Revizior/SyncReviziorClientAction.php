...
final class SyncReviziorClientAction
{
    public function __construct(
        private readonly ReviziorClientSynchronizer $synchronizer,
    ...
    public function __invoke(Request $request, Response $response, array $args): Response
    {
        ...
        try {
            ...
            $result = $this->synchronizer->upsert(
            ...
            $this->logger->error('ReviziOR client synchronization failed', [
