...
/** Reconciliation read (§2.13): opravný mechanismus při ztraceném webhooku, ne polling. */
final class GetReviziorInvoiceAction
{
    ...
    public function __invoke(Request $request, Response $response, array $args): Response
    {
        ...
        try {
            ...
            $this->logger->error('ReviziOR invoice read failed', ['request_id' => $requestId, 'exception' => $e::class]);
